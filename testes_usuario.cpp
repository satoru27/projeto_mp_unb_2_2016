...
{
	std::vector<int> coisas = { 1,3,5,6,4 };
	Usuario a(22, 0, 'm', "Felipe", coisas, "71929000");
	EXPECT_EQ(5, a.get_interesses().size());
	a.add_interesse(7);
	a.add_interesse(9);
	EXPECT_EQ(7, a.get_interesses().size());
